...
func (_m *Service) Store(cid int, companyName string, address string, telephone string) (sellers.Seller, error) {
...
func (_m *Service) Update(id int, cid int, companyName string, address string, telephone string) (sellers.Seller, error) {
