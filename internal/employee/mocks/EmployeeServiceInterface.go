...
// EmployeeServiceInterface is an autogenerated mock type for the EmployeeServiceInterface type
type EmployeeServiceInterface struct {
	mock.Mock
}

// Create provides a mock function with given fields: cardNumberId, firstName, lastName, wareHouseId
func (_m *EmployeeServiceInterface) Create(cardNumberId int, firstName string, lastName string, wareHouseId int) (employee.Employee, error) {
...
func (_m *EmployeeServiceInterface) DeleteById(id int) error {
	ret := _m.Called(id)
...
func (_m *EmployeeServiceInterface) GetAll() ([]employee.Employee, error) {
	ret := _m.Called()
...
func (_m *EmployeeServiceInterface) GetById(id int) (employee.Employee, error) {
	ret := _m.Called(id)
...
func (_m *EmployeeServiceInterface) UpdateById(id int, cardNumberId int, firstName string, lastName string, wareHouseId int) (employee.Employee, error) {
...
type mockConstructorTestingTNewEmployeeServiceInterface interface {
	mock.TestingT
	Cleanup(func())
}

// NewEmployeeServiceInterface creates a new instance of EmployeeServiceInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewEmployeeServiceInterface(t mockConstructorTestingTNewEmployeeServiceInterface) *EmployeeServiceInterface {
	mock := &EmployeeServiceInterface{}
	mock.Mock.Test(t)
