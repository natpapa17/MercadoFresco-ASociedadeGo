...
func (_m *RepositoryProduct) Create(product_code string, description string, width float64, height float64, length float64, net_weight float64, expiration_rate int, recommended_freezing_temperature float64, freezing_rate int, product_type_id int, seller_id int) (domain.Product, error) {
...
func (_m *RepositoryProduct) Delete(id int) error {
	ret := _m.Called(id)
...
func (_m *RepositoryProduct) GetAll() (domain.Products, error) {
	ret := _m.Called()
...
func (_m *RepositoryProduct) GetByCode(product_code string) (domain.Product, error) {
...
func (_m *RepositoryProduct) GetById(id int) (domain.Product, error) {
	ret := _m.Called(id)
...
func (_m *RepositoryProduct) Update(id int, product_code string, description string, width float64, height float64, length float64, net_weight float64, expiration_rate int, recommended_freezing_temperature float64, freezing_rate int, product_type_id int, seller_id int) (domain.Product, error) {
