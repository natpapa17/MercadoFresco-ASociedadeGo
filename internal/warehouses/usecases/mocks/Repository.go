...
func (_m *Repository) Create(warehouseCode string, address string, telephone string, minimumCapacity int, minimumTemperature float64) (domain.Warehouse, error) {
...
func (_m *Repository) GetAll() (domain.Warehouses, error) {
	ret := _m.Called()
...
func (_m *Repository) GetByWarehouseCode(code string) (domain.Warehouse, error) {
	ret := _m.Called(code)
...
func (_m *Repository) UpdateById(id int, warehouseCode string, address string, telephone string, minimumCapacity int, minimumTemperature float64) (domain.Warehouse, error) {
